...
Only supported if you also use fork: timkindberg/webpack-bundle-tracker
...
Then when you render multiple entries on a single page, use comma-separated bundle names:
```jinja2
{% render_bundle 'bundleA,bundleB' %}
```
